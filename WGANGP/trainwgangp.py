...
from utils import WGPD_train, WG_train, save_models, save_modelsv2
...
if __name__ == '__main__':
    ...
    parser.add_argument("--lambda_gp", type=float, default=10.0,
                        help="Coefficient multiplying the gradient penalty.")
    ...
    for epoch in trange(1, n_epoch + 1, leave=True):
        ...
        for batch_idx, (x, _) in enumerate(train_loader):
            ...
            for _ in range(args.critic_iterations):
                ...
                x = x.view(-1, mnist_dim)
                D_loss = WGPD_train(x, G, D, D_optimizer, args.lambda_gp)
                epoch_D_loss += -D_loss
                num_batches += 1
        ...
        if epoch % 10 == 0:
            save_modelsv2(G, D, f'checkpoints_train/wgpG_{epoch}.pth', f'checkpoints_train/wgpD_{epoch}.pth')
